...
/* ===============================================================================
WSDL Location    http://189.125.119.77/wstotvshom/cherwellintegration.asmx?wsdl 
Gerado em        04/12/18 11:27:07
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _SLTWQRR ; Return  // "dummy" function - Internal Use 
...
oXmlRet := SvcSoapCall(	Self,cSoap,; 
	...
	"http://189.125.119.77/wstotvshom/cherwellintegration.asmx") // endereço webservice cherwell - homologação
	
	//"http://189.125.201.234/wstotvs/cherwellintegration.asmx") - Endereço webservice cherwell - Produção.
...
oXmlRet := SvcSoapCall(	Self,cSoap,; 
	...
	"DOCUMENT","http://tempuri.org/",,,; 
	"http://189.125.119.77/wstotvshom/cherwellintegration.asmx")
