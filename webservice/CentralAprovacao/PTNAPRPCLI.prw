...
/* ===============================================================================
WSDL Location    http://187.94.60.7:8060/ws/CENTRAPR.apw?wsdl
Gerado em        02/07/19 19:07:18
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _OMZKMLM ; Return  // "dummy" function - Internal Use 
...
cSoap += '<APRCOTACAO xmlns="http://187.94.60.7:8060/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</APRCOTACAO>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8060/APRCOTACAO",; 
	"DOCUMENT","http://187.94.60.7:8060/",,"1.031217",; 
	"http://187.94.60.7:8060/ws/CENTRAPR.apw")
...
cSoap += '<CHQCOTACAO xmlns="http://187.94.60.7:8060/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQCOTACAO>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8060/CHQCOTACAO",; 
	"DOCUMENT","http://187.94.60.7:8060/",,"1.031217",; 
	"http://187.94.60.7:8060/ws/CENTRAPR.apw")
...
cSoap += '<CHQMAPCOT xmlns="http://187.94.60.7:8060/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQMAPCOT>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8060/CHQMAPCOT",; 
	"DOCUMENT","http://187.94.60.7:8060/",,"1.031217",; 
	"http://187.94.60.7:8060/ws/CENTRAPR.apw")
...
cSoap += '<CHQMAPPC xmlns="http://187.94.60.7:8060/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQMAPPC>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8060/CHQMAPPC",; 
	"DOCUMENT","http://187.94.60.7:8060/",,"1.031217",; 
	"http://187.94.60.7:8060/ws/CENTRAPR.apw")
...
cSoap += '<CHQPEDCOM xmlns="http://187.94.60.7:8060/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQPEDCOM>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8060/CHQPEDCOM",; 
	"DOCUMENT","http://187.94.60.7:8060/",,"1.031217",; 
	"http://187.94.60.7:8060/ws/CENTRAPR.apw")
...
cSoap += '<CHQVALCOT xmlns="http://187.94.60.7:8060/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQVALCOT>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8060/CHQVALCOT",; 
	"DOCUMENT","http://187.94.60.7:8060/",,"1.031217",; 
	"http://187.94.60.7:8060/ws/CENTRAPR.apw")
...
cSoap += '<CHQVALPC xmlns="http://187.94.60.7:8060/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQVALPC>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8060/CHQVALPC",; 
	"DOCUMENT","http://187.94.60.7:8060/",,"1.031217",; 
	"http://187.94.60.7:8060/ws/CENTRAPR.apw")
...
cSoap += '<LOGUSR xmlns="http://187.94.60.7:8060/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</LOGUSR>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8060/LOGUSR",; 
	"DOCUMENT","http://187.94.60.7:8060/",,"1.031217",; 
	"http://187.94.60.7:8060/ws/CENTRAPR.apw")
