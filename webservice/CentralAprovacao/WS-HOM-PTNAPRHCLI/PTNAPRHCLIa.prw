...
/* ===============================================================================
WSDL Location    http://187.94.60.7:8035/ws/CENTRAPR.apw?wsdl
Gerado em        10/14/16 13:56:00
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _XSLMFIT ; Return  // "dummy" function - Internal Use 
...
cSoap += '<APRCOTACAO xmlns="http://187.94.60.7:8035/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</APRCOTACAO>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8035/APRCOTACAO",; 
	"DOCUMENT","http://187.94.60.7:8035/",,"1.031217",; 
	"http://187.94.60.7:8035/ws/CENTRAPR.apw")
...
cSoap += '<APRPEDCOM xmlns="http://187.94.60.7:8035/">'
cSoap += WSSoapValue("LISTPCAP", ::oWSLISTPCAP, oWSLISTPCAP , "STARRAYPCAP", .T. , .F., 0 , NIL, .F.) 
cSoap += "</APRPEDCOM>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8035/APRPEDCOM",; 
	"DOCUMENT","http://187.94.60.7:8035/",,"1.031217",; 
	"http://187.94.60.7:8035/ws/CENTRAPR.apw")
...
cSoap += '<CHQCOTACAO xmlns="http://187.94.60.7:8035/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</CHQCOTACAO>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8035/CHQCOTACAO",; 
	"DOCUMENT","http://187.94.60.7:8035/",,"1.031217",; 
	"http://187.94.60.7:8035/ws/CENTRAPR.apw")
...
cSoap += '<CHQMAPCOT xmlns="http://187.94.60.7:8035/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</CHQMAPCOT>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8035/CHQMAPCOT",; 
	"DOCUMENT","http://187.94.60.7:8035/",,"1.031217",; 
	"http://187.94.60.7:8035/ws/CENTRAPR.apw")
...
cSoap += '<CHQMAPPC xmlns="http://187.94.60.7:8035/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</CHQMAPPC>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8035/CHQMAPPC",; 
	"DOCUMENT","http://187.94.60.7:8035/",,"1.031217",; 
	"http://187.94.60.7:8035/ws/CENTRAPR.apw")
...
cSoap += '<CHQPEDCOM xmlns="http://187.94.60.7:8035/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</CHQPEDCOM>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://187.94.60.7:8035/CHQPEDCOM",; 
	"DOCUMENT","http://187.94.60.7:8035/",,"1.031217",; 
	"http://187.94.60.7:8035/ws/CENTRAPR.apw")
...
WSMETHOD SOAPSEND WSCLIENT CENTRAPR_STARRAYPCAP
	Local cSoap := ""
	cSoap += WSSoapValue("LISTPCAP", ::oWSLISTPCAP, ::oWSLISTPCAP , "ARRAYOFPCAP", .T. , .F., 0 , NIL, .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT CENTRAPR_ARRAYOFPCAP
	Local cSoap := ""
	aEval( ::oWSPCAP , {|x| cSoap := cSoap  +  WSSoapValue("PCAP", x , x , "PCAP", .F. , .F., 0 , NIL, .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT CENTRAPR_PCAP
	...
	cSoap += WSSoapValue("CNUMPC", ::cCNUMPC, ::cCNUMPC , "string", .T. , .F., 0 , NIL, .F.) 
	cSoap += WSSoapValue("COBS", ::cCOBS, ::cCOBS , "string", .T. , .F., 0 , NIL, .F.) 
	cSoap += WSSoapValue("CSTATUS", ::cCSTATUS, ::cCSTATUS , "string", .T. , .F., 0 , NIL, .F.) 
	cSoap += WSSoapValue("CUSER", ::cCUSER, ::cCUSER , "string", .T. , .F., 0 , NIL, .F.) 
Return cSoap
