...
Gerado em        17/05/23 11:40:25
Observa��es      C�digo-Fonte gerado por ADVPL WSDL Client 1.120703
                 Altera��es neste arquivo podem causar funcionamento incorreto
                 e ser�o perdidas caso o c�digo-fonte seja gerado novamente.
=============================================================================== */

User Function _KWUGMOK ; Return  // "dummy" function - Internal Use 
...
If !FindFunction("XMLCHILDEX")
	UserException("O C�digo-Fonte Client atual requer os execut�veis do Protheus Build [7.00.210324P-20230411] ou superior. Atualize o Protheus ou gere o C�digo-Fonte novamente utilizando o Build atual.")
EndIf
Return Self
...
cSoap += '<APRCOTACAO xmlns="http://187.94.60.7:5103/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</APRCOTACAO>"

oXmlRet := SvcSoapCall(Self,cSoap,; 
	"http://187.94.60.7:5103/APRCOTACAO",; 
	"DOCUMENT","http://187.94.60.7:5103/",,"1.031217",; 
...
cSoap += '<CHQCOTACAO xmlns="http://187.94.60.7:5103/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQCOTACAO>"

oXmlRet := SvcSoapCall(Self,cSoap,; 
	"http://187.94.60.7:5103/CHQCOTACAO",; 
	"DOCUMENT","http://187.94.60.7:5103/",,"1.031217",; 
	"http://conportonovo-tst-protheus.totvscloud.com.br:5103/ws/CENTRAPR.apw")
...
cSoap += '<CHQMAPCOT xmlns="http://187.94.60.7:5103/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQMAPCOT>"

oXmlRet := SvcSoapCall(Self,cSoap,; 
	"http://187.94.60.7:5103/CHQMAPCOT",; 
	"DOCUMENT","http://187.94.60.7:5103/",,"1.031217",; 
	"http://conportonovo-tst-protheus.totvscloud.com.br:5103/ws/CENTRAPR.apw")
...
cSoap += '<CHQMAPPC xmlns="http://187.94.60.7:5103/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQMAPPC>"

oXmlRet := SvcSoapCall(Self,cSoap,; 
	"http://187.94.60.7:5103/CHQMAPPC",; 
	"DOCUMENT","http://187.94.60.7:5103/",,"1.031217",; 
	"http://conportonovo-tst-protheus.totvscloud.com.br:5103/ws/CENTRAPR.apw")
...
cSoap += '<CHQPEDCOM xmlns="http://187.94.60.7:5103/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQPEDCOM>"

oXmlRet := SvcSoapCall(Self,cSoap,; 
	"http://187.94.60.7:5103/CHQPEDCOM",; 
	"DOCUMENT","http://187.94.60.7:5103/",,"1.031217",; 
	"http://conportonovo-tst-protheus.totvscloud.com.br:5103/ws/CENTRAPR.apw")
...
cSoap += '<CHQVALCOT xmlns="http://187.94.60.7:5103/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQVALCOT>"

oXmlRet := SvcSoapCall(Self,cSoap,; 
	"http://187.94.60.7:5103/CHQVALCOT",; 
	"DOCUMENT","http://187.94.60.7:5103/",,"1.031217",; 
	"http://conportonovo-tst-protheus.totvscloud.com.br:5103/ws/CENTRAPR.apw")
...
cSoap += '<CHQVALPC xmlns="http://187.94.60.7:5103/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</CHQVALPC>"

oXmlRet := SvcSoapCall(Self,cSoap,; 
	"http://187.94.60.7:5103/CHQVALPC",; 
	"DOCUMENT","http://187.94.60.7:5103/",,"1.031217",; 
	"http://conportonovo-tst-protheus.totvscloud.com.br:5103/ws/CENTRAPR.apw")
...
cSoap += '<LOGUSR xmlns="http://187.94.60.7:5103/">'
cSoap += WSSoapValue("CRECEB", ::cCRECEB, cCRECEB , "string", .T. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</LOGUSR>"

oXmlRet := SvcSoapCall(Self,cSoap,; 
	"http://187.94.60.7:5103/LOGUSR",; 
	"DOCUMENT","http://187.94.60.7:5103/",,"1.031217",; 
	"http://conportonovo-tst-protheus.totvscloud.com.br:5103/ws/CENTRAPR.apw")
