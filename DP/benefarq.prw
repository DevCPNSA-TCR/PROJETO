...
PRivate cMVPAR13 := MV_PAR13
PRivate cMVPAR12 := MV_PAR12                                
...
// Codigo 1 - Empresas							                                       //
//-------------------------------------------------------------------------------------//
If RHGeraLinhas( aStruct[2], "01" ) <> CHR(13)+CHR(10) //RHGeraLinhas( aStruct[2], "01" ) <> NiL .AND. !Empty(RHGeraLinhas( aStruct[2], "01" ))
	nTotRegTP1 := 1
	nSeq += 1	
...
While QD02VB->(!Eof())
	...
	//Grava Detalhes
	If  RHGeraLinhas( aStruct[2], "02" ) <> CHR(13)+CHR(10) //RHGeraLinhas( aStruct[2], "02" ) <> NiL .AND. !Empty(RHGeraLinhas( aStruct[2], "02" ))
		nTotRegTP2 += 1
		nSeq += 1	
...
cQuery  += " RA_NASC,RA_CIC,RA_RG,RA_MAE,RA_EMAIL,RA_ESTCIVI,RA_SEXO,RA_PAI, RA_XMATVT "
...
While QD03VB->(!Eof())
   ...
   oProcess:IncRegua2(QD03VB->RA_NOME)
	...
	//Grava Detalhes Funcionario
	If  RHGeraLinhas( aStruct[2], "05" ) <> CHR(13)+CHR(10) //RHGeraLinhas( aStruct[2], "05" ) <> NiL .AND. !Empty(RHGeraLinhas( aStruct[2], "05" ))
		nTotRegTP5 += 1
		nSeq += 1
...
aAdd(aRegs,{cVBPerg,"02","Tipo de Beneficios ?","Tipo de Beneficios ?","Tipo de Beneficios ?","mv_ch2","C",08,0,0,"G","u_BENEFOpcoes()","mv_par02","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
