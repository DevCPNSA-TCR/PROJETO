...
±±ºPrograma  ³PTNR051   ºAutor  ³Lonardo Freire  º Data ³ 18/08/2015.     º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Nota de Debito da TCR.                                     º±±
±±º          ³                                                            º±±
...
While DIF->(!Eof())
    ...
    ///oPrn:Say(nLinB4F-30,nColI+15, "COBRANÇA CONFORME PREVISTA EM CONTRATO", oFont )
